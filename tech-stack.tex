...
Wdrażamy wtedy jedną z implementacji \emph{Ingress Controller} (najpopularniejsza to \emph{nginx}, w projekcie używam \emph{Istio}), która stanowi ruter dla pozostałych \cw{Service}’ów. 
