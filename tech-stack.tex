...
Wdrażana jest wtedy jedną z implementacji \emph{Ingress Controller} (najpopularniejsza to \emph{nginx}, w projekcie używam \emph{Istio} [\ref{istio}]), która stanowi ruter dla pozostałych \cw{Service}’ów. 
