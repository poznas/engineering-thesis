...
Przy użyciu tego narzędzia dalszy ciąg skryptów, uruchomionych w ramach \emph{UserData} \textbf{Kops\\Instance} \emph{(\ref{iac:cf})}, buduje \cw{Node}'y składające się na \cw{Cluster}.
...
\begin{enumerate}
    ...
    \cw{Service} ten następnie zwraca do Istio tylko jego identyfikator, w planach jest dołożenie jeszcze zbioru uprawnień. 
...
\begin{enumerate}
    ...
    W ten sposób poindeksowane są obiekty w tabeli \cw{GEOLOCATION}. Znacznie przyspiesza to zapytania o punkty w zadanym obszarze.
